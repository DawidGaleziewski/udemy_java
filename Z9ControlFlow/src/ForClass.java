public class ForClass {
    public static void main(String[] args) {
        ...
        calculateCompoundInterest(100000, 12, 0.5, 0.02);
    }
    ...
    public static void calculateCompoundInterest(double amount, int months, double interestRate, double compoundRate){
